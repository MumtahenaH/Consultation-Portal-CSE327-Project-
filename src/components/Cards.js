...
<div className='flex px-px'>
  ...
  <div className="flex-1 card lg:card-side bg-doctor-black text-neutral-50 font-bold shadow-xl m-4">
  ...
  <div className="flex-1 card lg:card-side bg-gradient-to-r from-doctor-green to-doctor-blue text-neutral-50 font-bold shadow-xl m-4">
